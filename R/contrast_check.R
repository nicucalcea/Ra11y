...
contrast_check <- function(col_1, col_2) {
  ...
  if (any(ratio < col_results)) {
    cli::cli_h1("Contrast")
    cli::cli_alert_danger(paste0("There may not be enough contrast between your colours. Consult {.href [WebAIM](https://webaim.org/resources/contrastchecker/?fcolor=", gsub("#", "", col_1), "&bcolor=", gsub("#", "", col_2), ")} for more details."))
